...
int main(int argc, char* argv[]) {  
  ...
  vector<double> lbp_time_list, lbp_prov_time_list, prov_query_time_list, prov_storage_list, lbp_coarse_prov_time_list, coarse_prov_storage_list, prov_query_coarse_time_list;
  ...
  //   prov_storage_list.push_back(mln.provG.getProvSize() / (1024*1024));
  ...
  for (int i=0; i<10; i++) {
    ...
    coarse_prov_storage_list.push_back(mln.provG.getProvSize() * 1.0 / (1024*1024));
  ...
  cout << endl;
  for (double t : prov_storage_list) {
    cout << t << ", ";
  }
  cout << endl;
  ...
  cout << endl;
  for (double t : coarse_prov_storage_list) {
    cout << t << ", ";
  }
